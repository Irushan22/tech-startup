    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 pb-16 border-b border-white/10">
          ...
          <div>
            <h4
              className="text-xs font-bold uppercase tracking-widest text-white/60 mb-6"
              style={{ fontFamily: "var(--font-montserrat), sans-serif" }}
            >
              Services
            </h4>
            <ul className="space-y-3">
              {footerLinks.services.map((link, i) => (
                <li key={i}>
                  <a href={link.href} className="text-sm text-white/35 hover:text-white transition-colors duration-200">
                    {link.label}
                  </a>
                </li>
              ))}
